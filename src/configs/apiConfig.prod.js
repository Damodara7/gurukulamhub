...
export const API_URLS = {
  v0: {
    ...
    USERS_QUIZ_DOCUMENTS: `${API_BASE_URL}/quiz/documents`,
    ...
    CLEANUP_UNVERIFIED_USERS: `${API_BASE_URL}/cleanup`,
    REFERRAL_SETTINGS: `${API_BASE_URL}/referral-settings`,
  ...
  v1: {
    ...
    USERS_QUIZ_DOCUMENTS: `${API_BASE_URL}/v1/quiz/documents`,
    ...
    CLEANUP_UNVERIFIED_USERS: `${API_BASE_URL}/v1/cleanup`,
    REFERRAL_SETTINGS: `${API_BASE_URL}/v1/referral-settings`,
