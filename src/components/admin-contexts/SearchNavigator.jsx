...
export default function SearchNavigator({ searchFoundCount, searchFocusIndex, selectPrevMatch, selectNextMatch }) {
  return (
    <Box className='flex gap-2 items-center justify-end' sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
      ...
      {/* Search Info */}
      <Typography variant='h5' sx={{ color: 'text.primary', whiteSpace: 'nowrap' }}>
