...
const QuestionBuilderArea = forwardRef(({ quiz, validationErrors = [], validateQuizQuestions, setQuestionsLength }, ref) => {
  ...
  return (
    <Stack spacing={2} sx={{ height: '100%', minHeight: 0, overflow: 'hidden', flexDirection: 'row' }}>
      ...
      <Box sx={{ flex: 3, height: '100%', minWidth: 0, display: 'flex', flexDirection: 'column' }}>
        <Box sx={{ p: 2, border: '1px solid', borderColor: 'divider', borderRadius: 1, minHeight: 0, height: '100%', display: 'flex', flexDirection: 'column' }}>
          {!hasClickedNew && (
