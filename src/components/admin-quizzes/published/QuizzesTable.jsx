...
const ActionsMenu = ({ anchorEl, handleClose, handleAction, isMobile = false }) => (
  ...
  >
    ...
    >
      <ListItemIcon>
        <NewReleasesOutlinedIcon sx={{ fontSize: { xs: '1.125rem', sm: '1.25rem' } }} />
      </ListItemIcon>
  ...
  return (
    ...
    >
      ...
      <CardContent sx={{ px: { xs: 1.5, sm: 3 }, pb: { xs: 2, sm: 3 }, flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0, overflow: 'hidden' }}>
                        ...
                        <tr
                          ...
                          style={{
                            background: row.getIsSelected()
                              ? `linear-gradient(135deg, ${alpha(theme.palette.info.main, 0.15)} 0%, ${alpha(
                                  theme.palette.info.dark,
                                  0.15
                                )} 100%)`
                              : index % 2 === 0
                                ? `linear-gradient(135deg, ${alpha(theme.palette.info.main, 0.03)} 0%, ${alpha(
                                    theme.palette.info.dark,
                                    0.03
                                  )} 100%)`
                          ...
                          onMouseEnter={e => {
                            e.currentTarget.style.background = `linear-gradient(135deg, ${alpha(
                              ...
                              0.12
                            )} 0%, ${alpha(theme.palette.info.dark, 0.12)} 100%)`
                            e.currentTarget.style.borderLeft = `3px solid ${theme.palette.info.main}`
                          }}
                          onMouseLeave={e => {
        ...
        {/* Pagination component - Only show on desktop/tablet when not loading */}
...
export default AdminPublishedQuizzesTable
