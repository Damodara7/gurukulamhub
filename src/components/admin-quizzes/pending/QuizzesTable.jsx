...
const AdminPendingQuizzesTable = ({ data, refreshData, serverPagination }) => {
              ...
              {displayRows.map(row => {
                ...
                return (
                  <Box
                    ...
                    sx={{
                      borderRadius: 3,
                      border: `1px solid ${alpha(theme.palette.divider, theme.palette.mode === 'dark' ? 0.12 : 0.15)}`,
                      boxShadow:
...
export default AdminPendingQuizzesTable
