...
const MultipleChoiceQuestionTemplate = ({
  ...
  const [options, setOptions] = useState(
    innerData?.options
      ...
      : mode === 'primary'
        ? [
            { id: '1', text: 'Option 1', correct: false, image: '', file: null, mediaType: 'text' },
            { id: '2', text: 'Option 2', correct: false, image: '', file: null, mediaType: 'text' }
          ]
        : primaryQuestion?.data?.options || [
            { id: '1', text: 'Option 1', correct: false, image: '', mediaType: 'text' },
            { id: '2', text: 'Option 2', correct: false, image: '', mediaType: 'text' }
          ]
  )
