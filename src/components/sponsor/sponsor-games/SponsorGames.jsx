...
const SponsorGames = () => {
  ...
  return (
    ...
    >
      {/* Clean Professional Header - Fixed */}
      <Box
        sx={{
          flexShrink: 0,
      ...
      >
        <Container maxWidth='lg' sx={{ mt: 4, pb: { xs: 6, sm: 8, md: 10 }, position: 'relative', zIndex: 2 }}>
          {games.length === 0 ? (
            <Card
              sx={{
            ...
            <Grid container spacing={{ xs: 2, sm: 2.5, md: 3 }}>
              {games.map(game => {
                ...
                const totalRemaining =
                  game.rewards?.reduce((sum, reward) => sum + calculateRemainingNeed(reward), 0) || 0
                ...
                return (
                  <Grid item xs={12} sm={6} md={6} lg={4} key={game._id}>
                    ...
                    >
                      ...
                      <CardContent
                        sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', p: { xs: 2.5, sm: 3 } }}
                      >
                        {/* Title & Quiz */}
