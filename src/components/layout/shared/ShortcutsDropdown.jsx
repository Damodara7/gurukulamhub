...
const ShortcutsDropdown = ({ shortcuts }) => {
  ...
  return (
    <>
      <IconButtonTooltip title='Favorite' ref={anchorRef} onClick={handleToggle} className='!text-textPrimary'>
              ...
              <ClickAwayListener onClickAway={handleClose}>
                <div>
                  <div className='flex items-center justify-between plb-2 pli-4 is-full gap-2'>
                    ...
                    >
                      <IconButtonTooltip title='Add' size='small' className='text-textPrimary'>
