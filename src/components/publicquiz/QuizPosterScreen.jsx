...
function QuizPosterScreen({ quizData, onClickStart, language = null, quizLanguages = [] }) {
  ...
  return (
    <Box
      sx={{ width: '100%', position: 'relative', pb: 8, maxWidth: '1200px', margin: 'auto' }}
      className='flex flex-col items-center'
    >
      {/* Thumbnail Section */}
      ...
      <Box className='flex flex-col items-center'>
        <Grid container spacing={3} sx={{ mb: 4 }} className='flex flex-col items-stretch'>
          <Grid item xs={12}>
