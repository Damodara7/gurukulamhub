...
const GameDefaultValues = {
  ...
  "gameStatus": "archive" // live - active - archive
}
...
const GamesArchive = mongoose.models.gamesArchive || mongoose.model('gamesArchive', ArtifactSchemaLatest, "gamesArchive");
module.exports = GamesArchive;
