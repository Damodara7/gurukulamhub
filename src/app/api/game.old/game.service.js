...
import GamesActiveModel from '../game-active/game.model.js'
import GamesLiveModel from '../game-live/game.live.model.js'
import GamesArchiveModel from '../game-archive/game.model.js'

import { gameCreateRequestDtoSchema } from './game.validator.js'
import * as ApiResponseUtils from '@/utils/apiResponses'

const Artifact = 'Games'
const ArtifactModel = Games
...
export async function add(addRequestData) {
  ...
  try {
    ...
    const newGameActiveArtifact = new GamesActiveModel({ ...addRequestData })
    newGameActiveArtifact.gameStatus = 'active';
    await newArtifact.save();
    await newGameActiveArtifact.save();
