...
export default function GroupChatRoute() {
  ...
  // Don't show separate loading state - let GroupChatPage handle it
  // This prevents double loading ("Loading chat..." then "Loading messages...")
  ...
  return (
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <GroupChatPage groupId={groupId} groupData={groupData} backPath='/messanger' />
    </Box>
  )
}
