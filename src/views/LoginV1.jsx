          ...
          <div className='flex flex-col gap-5'>
            ...
            <form noValidate autoComplete='off' onSubmit={e => e.preventDefault()} className='flex flex-col gap-5'>
              ...
              <div className='flex justify-center items-center gap-2'>
                <IconButtonTooltip title='Facebook' className='text-facebook'>
                  <i className='ri-facebook-fill' />
                </IconButtonTooltip>
                <IconButtonTooltip title='Twitter' className='text-twitter'>
                  <i className='ri-twitter-fill' />
                </IconButtonTooltip>
                <IconButtonTooltip title='Github' className='text-github'>
                  <i className='ri-github-fill' />
                </IconButtonTooltip>
                <IconButtonTooltip title='Google' className='text-googlePlus'>
