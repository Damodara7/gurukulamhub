      ...
      >
        ...
        <Container maxWidth='lg' sx={{ py: { xs: 4, md: 5 }, pb: { xs: 6, sm: 8, md: 10 } }}>
            ...
            <Grid container spacing={4}>
              ...
              <Grid item xs={12} md={4}>
                <Paper elevation={2} sx={{ p: 3, height: '100%' }}>
                  ...
                  <Typography variant='body2' color='text.secondary'>
                    Yes! We take data security seriously, and all donations are processed through secure payment
                    gateways.
                  </Typography>
                </Paper>
              </Grid>
              <Grid item xs={12} md={4}>
                <Paper elevation={2} sx={{ p: 3, height: '100%' }}>
                  ...
                  <Typography variant='body2' color='text.secondary'>
                    Donations are final, but if there are any issues, please reach out to our support team, and we will
          ...
          <Box sx={{ mt: 8, textAlign: 'center' }}>
            <Typography variant='body2' color='text.secondary'>
              Thank you for considering a donation. Together, we can make learning more engaging and fun for everyone in
              the Gurukulhub community!
            </Typography>
          </Box>
        </Container>
      </Box>
